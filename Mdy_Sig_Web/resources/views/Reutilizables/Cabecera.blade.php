<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row navbar-success">
    <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
            <a class="navbar-brand brand-logo" href="#"><img src="src/images/logo.svg" alt="logo"></a>
            <a class="navbar-brand brand-logo-mini" href="../../index.html"><img src="src/images/logo-mini.svg"
                    alt="logo"></a>
        ...
        <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-date dropdown">
                <a class="nav-link d-flex justify-content-center align-items-center" href="javascript:;">
                    <h6 class="date mb-0"><?php echo date ( 'Y-m-d' ) ?></h6>
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="src/images/faces/face4.jpg" alt="image" class="profile-pic">
                        </div>
